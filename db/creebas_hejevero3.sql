...
CREATE TABLE IF NOT EXISTS `hejevero3`.`product` (
  ...
  `PaNu_pro` VARCHAR(45) NULL,
  `Nam_pro` VARCHAR(45) NULL,
  `Mod_pro` VARCHAR(45) NULL,
  `Man_pro` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `hejevero3`.`serial`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hejevero3`.`serial` (
  `Id_serial` INT NOT NULL,
  `Cod_serial` VARCHAR(45) NULL,
  `Sta_serial` VARCHAR(5) NULL,
  `product_Id_pro` INT NOT NULL,
  PRIMARY KEY (`Id_serial`),
  INDEX `fk_serial_product1_idx` (`product_Id_pro` ASC),
  CONSTRAINT `fk_serial_product1`
    FOREIGN KEY (`product_Id_pro`)
    REFERENCES `hejevero3`.`product` (`Id_pro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `hejevero3`.`sell`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hejevero3`.`sell` (
  `Id_sell` INT NOT NULL,
  `Det_sell` VARCHAR(45) NULL,
  `Dat_sell` VARCHAR(45) NULL,
  `Tot_sell` VARCHAR(45) NULL,
  `Net_sell` VARCHAR(45) NULL,
  `Iva_sell` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `hejevero3`.`product_sell`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hejevero3`.`product_sell` (
  `Id_ps` INT NOT NULL,
  `Dat_ps` VARCHAR(45) NULL,
  `Sta_ps` VARCHAR(5) NULL,
  `sell_Id_sell` INT NOT NULL,
  `serial_Id_serial` INT NOT NULL,
  PRIMARY KEY (`Id_ps`),
  INDEX `fk_product_sell_sell1_idx` (`sell_Id_sell` ASC),
  INDEX `fk_product_sell_serial1_idx` (`serial_Id_serial` ASC),
  CONSTRAINT `fk_product_sell_sell1`
    FOREIGN KEY (`sell_Id_sell`)
    REFERENCES `hejevero3`.`sell` (`Id_sell`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_product_sell_serial1`
    FOREIGN KEY (`serial_Id_serial`)
    REFERENCES `hejevero3`.`serial` (`Id_serial`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hejevero3`.`client`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hejevero3`.`client` (
  `Id_client` INT NOT NULL,
  `Nam_client` VARCHAR(45) NULL,
  `Rut_client` VARCHAR(45) NULL,
  `Rol_client` VARCHAR(45) NULL,
  `Dir_client` VARCHAR(45) NULL,
  `Cou_client` VARCHAR(45) NULL,
  `Cit_client` VARCHAR(45) NULL,
  `Cel_client` VARCHAR(45) NULL,
  `Mai_client` VARCHAR(45) NULL,
  `Sta_client` VARCHAR(5) NULL,
  PRIMARY KEY (`Id_client`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `hejevero3`.`client_sell`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hejevero3`.`client_sell` (
  `Id_cs` INT NOT NULL,
  `Sta_cs` VARCHAR(45) NULL,
  `sell_Id_sell` INT NOT NULL,
  `client_Id_client` INT NOT NULL,
  PRIMARY KEY (`Id_cs`),
  INDEX `fk_client_sell_sell1_idx` (`sell_Id_sell` ASC),
  INDEX `fk_client_sell_client1_idx` (`client_Id_client` ASC),
  CONSTRAINT `fk_client_sell_sell1`
    FOREIGN KEY (`sell_Id_sell`)
    REFERENCES `hejevero3`.`sell` (`Id_sell`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_client_sell_client1`
    FOREIGN KEY (`client_Id_client`)
    REFERENCES `hejevero3`.`client` (`Id_client`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
